...
namespace AssetTracker.Web.Controllers
{
    public class SubCategoryController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,Code,CategoryId")] SubCategory subcategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,Code,CategoryId")] SubCategory subcategory)
        {
            if (ModelState.IsValid)
            {
